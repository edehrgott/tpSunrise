...
on the right and a flexible center column that automatically adjusts for the window width.

This theme supports a slightly different style for the home page and the sub pages. The home page is intended 
to be more graphical and can accommodate a different header graphic and left sidebar background. The main css 
file (style.css) is styled for the sub pages. The home page styles are affected using jQuery through the 
nav_background_alt.php file. 

The home page header graphic is in images/tekpals_liquid_big_header.png and the sub page header is at
images/tekpals_liquid_sub_header.png. These filenames may be changed in home_logo.php and sub_logo.php as needed.
...
WordPress, php and jQuery through their blogs. Thanks!
